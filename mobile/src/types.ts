...
export type User = { id: number; name: string; email: string; phone?: string | null; role: Role; avatar_url?: string | null; school: { id: number; number: string; name: string }; permissions: string[] };
