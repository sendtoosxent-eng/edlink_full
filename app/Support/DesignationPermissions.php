...
class DesignationPermissions
{
    public static function groups(): array
    {
        return [
            ...
            'finance' => ['label' => 'Finance', 'rights' => ['finance.payments' => 'Record payments and receipts', 'finance.expenses' => 'Manage expenses', 'finance.reports' => 'View financial reports']],
    ...
    {
        return [
            'Class Teacher' => ['students.view','attendance.daily','attendance.reports','academics.events','exams.results','parents.communications','reports.view'],
            'Subject Teacher' => ['students.view','attendance.subject','academics.subjects','academics.timetable','exams.marks','exams.results','reports.view'],
            'Bursar' => ['students.view','finance.payments','finance.expenses','finance.reports','staff.payroll','reports.view'],
