...
class EnsureDesignationAccess
{
    public function handle(Request $request, Closure $next): Response
    {
        ...
        $permission = match ($route) {
            ...
            'finance.ledger' => null,
            'finance.ledger.approve', 'finance.ledger.reject', 'finance.ledger.reverse', 'finance.accounts.store',
            'finance.transfers.store', 'finance.transfers.approve' => 'finance.ledger',
            ...
            'accounting.reconciliations', 'accounting.reconciliations.store', 'accounting.reconciliations.reopen' => 'accounting.reconciliations.manage',
            ...
            'grading-scales.index' => 'exams.setup',
            ...
            'reports.index', 'reports.exports.download', 'reports.student-term-report',
            'reports.student-term-report.show', 'reports.bulk-term-reports' => 'reports.view',
