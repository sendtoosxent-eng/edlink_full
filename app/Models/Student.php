...
class Student extends Model
{
    ...
    public function totalDue(?Term $term = null): float
    {
        ...
        return $this->adjustedFeeAmount($term) + $this->arrearsDueIn($term);
    }
    ...
    public function adjustedFeeAmount(?Term $term = null): float
    {
        $baseFee = (float) ($this->mappedFeeAmount($term) ?? 0);

        return max(0, $baseFee - $this->feeAdjustmentTotal($term));
    }
